...
export class Client<HT extends Record<string, string> = never> {
  ...
  async getUsersUserid(opts: { path: { userId: string } }) {
  ...
  async deleteUsersUserid(opts: { path: { userId: string } }) {
  ...
  async getUsersUseridLoans(opts: { path: { userId: string } }) {
  ...
  async postUsersBulk(opts: { body: { file?: string } }) {
